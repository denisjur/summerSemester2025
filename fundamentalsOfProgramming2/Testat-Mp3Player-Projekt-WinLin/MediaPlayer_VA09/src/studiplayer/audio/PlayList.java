...
public class PlayList implements Iterable<AudioFile> {
	...
	public void setSortCriterion(SortCriterion sortCriterion) {
		...
		// nur für SortCriterion.ALBUM wirklich sortieren (andere Comparatoren greifen über Iterator)
		if (sortCriterion == SortCriterion.ALBUM) {
			audioFiles.sort(new AlbumComparator());
		}

		iterator = new ControllablePlayListIterator(audioFiles, search, sortCriterion);
		resetCurrentFile();  // sorgt dafür, dass currentFile korrekt gesetzt ist
	}
