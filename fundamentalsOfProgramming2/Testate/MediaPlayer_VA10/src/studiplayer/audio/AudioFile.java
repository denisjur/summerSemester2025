...
public abstract class AudioFile {
	...
	// modificat pentru a arunca NotPlayableException în loc de RuntimeException
	public AudioFile(String path) throws NotPlayableException {
		...
		if (!file.exists() || !file.isFile() || !file.canRead()) {
			throw new NotPlayableException(this.pathname, "Datei nicht lesbar");
		}
	...
	// Zeit in Millisekunden (kannst du behalten oder anpassen)
	public long getTimeInMillis() {
	    return 0; // oder deine eigene Logik
	}
